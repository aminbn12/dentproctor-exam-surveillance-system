// Service API pour communiquer avec le backend APP surveillances UM6SS

const API_BASE_URL =
  process.env.REACT_APP_API_URL || "http://localhost:8100/api";
...
class ApiClient {
  ...
  async addProfessorAbsence(id: string, date: string) {
    return this.request(`/professors/${id}/absences`, "POST", {
      absence_date: date,
    });
  }
